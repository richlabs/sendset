...
//THIS FUNCTION MANAGES THE CANVAS SCALING TO FIT PROPORTIONALLY THE GAME TO THE CURRENT DEVICE RESOLUTION
                ...
                var w = getSize("Width");
                        s_fScaleCanvas = Math.min((h / CANVAS_HEIGHT), (w / CANVAS_WIDTH))
                        s_iScaleFactor = s_fScaleCanvas;
...
//                $("#canvas").css("height", (CANVAS_HEIGHT*0.92) + "px");
        ...
        var oCamera = new THREE.PerspectiveCamera(FOV, CANVAS_WIDTH / CANVAS_HEIGHT, NEAR, FAR);
                //  oCamera.lookAt(new THREE.Vector3(OFFSET_TRACK_POSITION.x, OFFSET_TRACK_POSITION.y, OFFSET_TRACK_POSITION.z));

                oCamera.rotation.x = CAMERA_PROPERTIES.rot_x * (Math.PI / 180);
                oCamera.rotation.y = CAMERA_PROPERTIES.rot_y * (Math.PI / 180);
                oCamera.rotation.z = CAMERA_PROPERTIES.rot_z * (Math.PI / 180);
                //oCamera.zoom = 6;//4.0;
...
//    oCamera.bottom = CANVAS_HEIGHT / -2;
                ...
                oCamera.position.set(CAMERA_PROPERTIES.x, CAMERA_PROPERTIES.y, CAMERA_PROPERTIES.z);
